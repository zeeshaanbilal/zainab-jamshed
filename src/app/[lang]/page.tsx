...
export default async function Home({ params }: { params: { lang: string } | Promise<{ lang: string }> }) {
  // Ensure compatibility with Next.js 15 async params
    ...
    <div className="flex w-full flex-1 flex-col">
            ...
            <div className="flex flex-col space-y-6">
              ...
              <ul className="flex flex-col space-y-5 pt-4 animate-slide-up" style={{ animationDelay: '0.45s' }}>
                <li className="flex items-center gap-4">
                  ...
                  <span className="text-[#3b3b58] font-bold text-base md:text-[1.05rem]">{dict.about.bullet1}</span>
                </li>
                <li className="flex items-center gap-4">
                  <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#7749F8] text-white">
                    <svg className="h-3 w-3" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-[#3b3b58] font-bold text-base md:text-[1.05rem]">{dict.about.bullet2}</span>
                </li>
                <li className="flex items-center gap-4">
                  <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#7749F8] text-white">
                    <svg className="h-3 w-3" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-[#3b3b58] font-bold text-base md:text-[1.05rem]">{dict.about.bullet3}</span>
                </li>
              </ul>
      ...
      <section className="w-full bg-white py-24 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <TestimonialSlider testimonials={dict.testimonials.list} />
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-5">
            ...
            <div className="flex flex-col items-start justify-between border-2 border-slate-400 rounded-[18px] py-6 px-6 bg-white hover:shadow-md transition-shadow min-h-[140px]">
              <p className="text-slate-400 text-[13px] md:text-sm font-medium animate-slide-down">{dict.whyChooseUs.stat1}</p>
            ...
            {/* Card 2 */}
            <div className="flex flex-col items-start justify-between border-2 border-slate-400 rounded-[18px] py-6 px-6 bg-white hover:shadow-md transition-shadow min-h-[140px]">
              <p className="text-slate-400 text-[13px] md:text-sm font-medium animate-slide-down">{dict.whyChooseUs.stat2}</p>
            ...
            {/* Card 3 */}
            <div className="flex flex-col items-start justify-between border-2 border-slate-400 rounded-[18px] py-6 px-6 bg-white hover:shadow-md transition-shadow min-h-[140px]">
              <p className="text-slate-400 text-[13px] md:text-sm font-medium animate-slide-down">{dict.whyChooseUs.stat3}</p>
            ...
            {/* Card 4 */}
            <div className="flex flex-col items-start justify-between border-2 border-slate-400 rounded-[18px] py-6 px-6 bg-white hover:shadow-md transition-shadow min-h-[140px]">
              <p className="text-slate-400 text-[13px] md:text-sm font-medium animate-slide-down">{dict.whyChooseUs.stat4}</p>
      ...
      <section className="w-full bg-[#fcfcfc] py-16 border-t border-b border-gray-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24">
            <img src="/meezan.svg" alt="Meezan Bank" className="h-10 md:h-14 object-contain" />
            <img src="/bayer.svg" alt="Bayer Pharmaceuticals" className="h-10 md:h-14 object-contain" />
            <img src="/nfl.png" alt="NFL" className="h-12 md:h-16 object-contain" />
            <img src="/coca-cola.svg" alt="The Coca-Cola Company" className="h-10 md:h-14 object-contain" />
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-white py-24 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <FAQAccordion faqs={dict.faqs.list} />
        </div>
      </section>
