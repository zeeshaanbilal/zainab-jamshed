        ...
        <div className="mx-auto max-w-[950px]">
          ...
          <div className="flex flex-col gap-8 text-gray-800">
            ...
            {/* Title & Subtitle */}
              ...
              <h2 className="text-[17px] sm:text-[19px] md:text-[21px] lg:text-[22px] tracking-tight whitespace-nowrap truncate font-bold text-black mb-4">Business Modeling Architect scalable, profit-focused business models</h2>
            ...
            {/* Who it's for */}
              ...
              <p className="text-[#64748b] text-[16px] leading-relaxed">
                Leaders redesigning operations, pricing, or product portfolios; teams pursuing growth with margin discipline.
              </p>
            </div>
