        ...
        <div className="mx-auto max-w-[950px]">
          ...
          <div className="flex flex-col gap-8 text-gray-800">
            ...
            <div className="opacity-0 animate-slide-right" style={{ animationDelay: '0.4s' }}>
              <h2 className="text-[17px] sm:text-[19px] md:text-[21px] lg:text-[22px] tracking-tight whitespace-nowrap truncate font-bold text-black mb-4">{dict.servicesDetails.churnAnalysis.title}</h2>
