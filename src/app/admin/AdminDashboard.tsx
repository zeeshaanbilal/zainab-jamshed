              ...
              <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div>
                    ...
                    <input required type="text" name="imageUrl" defaultValue={editingBlog?.image} placeholder="https://example.com/image.jpg" className="w-full border border-gray-300 rounded-lg p-2.5 text-sm text-gray-900 bg-white focus:ring-[#7749F8] focus:border-[#7749F8]" />
                  </div>
                </div>
                <p className="text-xs text-gray-500 mt-2 italic">
                  Note: Provide a direct URL to an image. You can upload your image to sites like ImgBB or Imgur and paste the link here.
                </p>
              </div>
