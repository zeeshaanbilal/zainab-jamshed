...
export default function MobileMenuClient({ dict, lang }: { dict: any, lang: string }) {
  ...
  return (
    <>
      ...
      {/* Side drawer */}
      <div 
        className={`fixed top-0 right-0 h-full w-[280px] bg-white z-[110] transform transition-transform duration-300 ease-in-out md:hidden flex flex-col overflow-y-auto ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
      >
        ...
        <div className="mt-auto p-6 flex flex-col space-y-4 border-t border-gray-100">
